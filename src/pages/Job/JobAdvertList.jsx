...
export default function JobAdvertList() {
  ...
  useEffect(() => {
    ...
    jobAdvertService
      .getByJobAdvertFilter(pageNo, pageSize, filters)
      .then((result) => {
    ...
    favoriteService
      .getByCandidateId(29, pageNo, pageSize)
      .then((result) => setFavorites(result.data.data.content));
                          ...
                          <Feed.Like>
                            {handleCheckToFavorite(jobAdvert.id) === true ? (
                              <Rating
                                ...
                                size="large"
                                onClick={() =>
                                  handleRemoveToFavorite(29, jobAdvert.id)
                                }
                              />
                            ) : (
                              <Rating
                                ...
                                size="large"
                                onClick={() =>
                                  handleAddToFavorite(29, jobAdvert.id)
                                }
                              />
                            )}
                          </Feed.Like>
